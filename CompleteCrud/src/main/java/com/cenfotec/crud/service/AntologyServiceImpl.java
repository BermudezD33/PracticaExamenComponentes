...
public class AntologyServiceImpl implements AntologyService {
	...
	@Override
	public List<Antology> get(String titulo) { return repo.findByNameContaining(titulo);}

	@Override
	public List<Antology> getFecha (String fecha) { return repo.findByNameContaining(fecha);}
